//
// WithoutConvSharpenBrush.cpp
//
// The implementation of Without Convolution Sharpen Brush. It is a kind of ImpBrush. All your brush implementations
...
WithoutConvSharpenBrush::WithoutConvSharpenBrush(ImpressionistDoc* pDoc, char* name) :
ImpBrush(pDoc, name)
{
}

void WithoutConvSharpenBrush::BrushBegin(const Point source, const Point target)
{
...
void WithoutConvSharpenBrush::SetColor(const Point source) {
...
void WithoutConvSharpenBrush::BrushMove(const Point source, const Point target)
{
	ImpressionistDoc* pDoc = GetDocument();
	ImpressionistUI* dlg = pDoc->m_pUI;
...
void WithoutConvSharpenBrush::BrushEnd(const Point source, const Point target)
{
}
